...
<b style='color:red;'>This setup is to try out this technology and not meant to be ready for production.</b>
...
4.  **Install NemoClaw**<br>
    ...
    --------------------------------------------------------------- <br>
            _curl -fsSL https://nvidia.com/nemoclaw.sh | sudo bash_ <br>
    --------------------------------------------------------------- <br>
